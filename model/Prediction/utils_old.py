...
class ngsimDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(np.shape(hist)) # 35, 2
        # print(np.shape(fut)) # 50, 2
        # print(np.shape(upper_neighbors)) # 21,
        # print(np.shape(neighbors)) # 39, 
    ...
    def collate_fn(self, samples):
        ...
        # print(type(hist_batch))
        # print(type(upp_nbrs_batch))
        # print(type(nbrs_batch))
        # print(type(upp_mask_batch))
        # print(type(mask_batch))
        # print(type(lat_enc_batch))
        # print(type(lon_enc_batch))
        # print(type(fut_batch))
        # print(type(op_mask_batch))

        # print("hi")

        # print(np.shape(hist_batch))
        # print(np.shape(upp_nbrs_batch))
        # print(np.shape(nbrs_batch))
        # print(np.shape(upp_mask_batch))
        # print(np.shape(mask_batch))
        # print(np.shape(lat_enc_batch))
        # print(np.shape(lon_enc_batch))
        # print(np.shape(fut_batch))
        # print(np.shape(op_mask_batch))

        # torch.Size([35, 128, 2])
        # torch.Size([34, 729, 2])
        # torch.Size([35, 1203, 2])
        # torch.Size([128, 3, 7, 64])
        # torch.Size([128, 3, 13, 64])
        # torch.Size([128, 3])
        # torch.Size([128, 2])
        # torch.Size([50, 128, 2])
        # torch.Size([50, 128, 2])
